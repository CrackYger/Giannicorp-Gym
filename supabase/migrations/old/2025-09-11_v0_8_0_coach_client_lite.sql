...
-- ============== Helper Functions ==============
do $$ begin
  create or replace function public.stamp_timestamps() returns trigger as $$
  begin
...
-- exercise_e1rm (falls vorhanden)
do $$
declare relid oid;
begin
  select c.oid into relid from pg_class c join pg_namespace n on n.oid = c.relnamespace
  where n.nspname = 'public' and c.relname = 'exercise_e1rm' and c.relkind = 'r';
