...
-- Giannicorp Gym – v0.8.0 Coach/Client Lite (NO-DO, with spaces bootstrap)
-- Idempotent: CREATE TABLE IF NOT EXISTS / DROP IF EXISTS / CREATE OR REPLACE.

------------------------------------------------------------
-- 0) BOOTSTRAP: minimal spaces table (only if missing)
------------------------------------------------------------
...
-- exercise_e1rm (OPTIONAL — exists? then uncomment & run)
